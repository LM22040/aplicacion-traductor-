...
public class Screen2 extends Form implements Runnable {
    ...
    static final IntNum Lit34 = IntNum.make(new int[]{-1});
    static final IntNum Lit33 = IntNum.make(-1038);
    static final SimpleSymbol Lit32 = (SimpleSymbol) new SimpleSymbol("Height").readResolve();
    static final IntNum Lit31 = IntNum.make(20);
    static final SimpleSymbol Lit30 = (SimpleSymbol) new SimpleSymbol("Label3").readResolve();
    ...
    static final IntNum Lit27 = IntNum.make(new int[]{-1});
    static final DFloNum Lit26 = DFloNum.make(18.5d);
    ...
    static final IntNum Lit17 = IntNum.make(28);
    static final SimpleSymbol Lit16 = (SimpleSymbol) new SimpleSymbol("FontSize").readResolve();
    static final SimpleSymbol Lit15 = (SimpleSymbol) new SimpleSymbol("Label1").readResolve();
    ...
    public Screen2() {
        ...
        frameVar.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frameVar, 1, Lit38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frameVar, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frameVar, 3, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frameVar, 4, Lit40, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frameVar, 5, Lit41, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frameVar, 7, Lit42, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frameVar, 8, Lit43, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frameVar, 9, Lit44, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frameVar, 10, Lit45, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frameVar, 11, Lit46, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frameVar, 12, Lit47, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frameVar, 13, Lit48, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frameVar, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frameVar, 15, Lit49, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frameVar, 16, Lit50, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frameVar, 17, Lit51, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit10, "unspecified", simpleSymbol5);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit11, Boolean.TRUE, simpleSymbol3);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit12, "Responsive", simpleSymbol5);
            Values.writeValues(runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit13, "Screen2", simpleSymbol5), $result);
        } else {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToComponents(simpleSymbol, Lit23, Lit15, lambda$Fn4);
        }
        this.Label2 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit24, Lit25, lambda$Fn5), $result);
        } else {
            addToComponents(simpleSymbol, Lit28, Lit25, lambda$Fn6);
        }
        this.Label3 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit29, Lit30, lambda$Fn7), $result);
        } else {
            addToComponents(simpleSymbol, Lit37, Lit30, lambda$Fn8);
        }
        runtime.initRuntime();
    }
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit11, Boolean.TRUE, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit12, "Responsive", simpleSymbol5);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit13, "Screen2", simpleSymbol5);
    }

    static Object lambda4() {
        SimpleSymbol simpleSymbol = Lit15;
        SimpleSymbol simpleSymbol2 = Lit16;
        IntNum intNum = Lit17;
        SimpleSymbol simpleSymbol3 = Lit9;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit18, "WhatsApp Translate+", Lit6);
    ...
    static Object lambda6() {
        ...
        SimpleSymbol simpleSymbol2 = Lit16;
        DFloNum dFloNum = Lit26;
        SimpleSymbol simpleSymbol3 = Lit9;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, dFloNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit18, "¿Cómo utilizar el Traductor de WhatsApp?", Lit6);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit21, Lit27, simpleSymbol3);
    }
    ...
    static Object lambda8() {
        ...
        SimpleSymbol simpleSymbol3 = Lit9;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit32, Lit33, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit18, "Asegúrate de que \"Traducir WhatsApp\" esté\nhabilitado arriba. A continuación, visita cualquier\nchat de WhatsApp y simplemente pulsa el boton de\ntraducción.", Lit6);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit19, Lit20, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit21, Lit34, simpleSymbol3);
