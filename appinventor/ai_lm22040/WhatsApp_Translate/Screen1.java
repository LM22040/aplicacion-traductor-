...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit45 = (SimpleSymbol) new SimpleSymbol("lookup-handler").readResolve();
    static final SimpleSymbol Lit44 = (SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve();
    static final SimpleSymbol Lit43 = (SimpleSymbol) new SimpleSymbol("dispatchEvent").readResolve();
    static final SimpleSymbol Lit42 = (SimpleSymbol) new SimpleSymbol("send-error").readResolve();
    static final SimpleSymbol Lit41 = (SimpleSymbol) new SimpleSymbol("add-to-form-do-after-creation").readResolve();
    static final SimpleSymbol Lit40 = (SimpleSymbol) new SimpleSymbol("add-to-global-vars").readResolve();
    static final SimpleSymbol Lit39 = (SimpleSymbol) new SimpleSymbol("add-to-components").readResolve();
    static final SimpleSymbol Lit38 = (SimpleSymbol) new SimpleSymbol("add-to-events").readResolve();
    static final SimpleSymbol Lit37 = (SimpleSymbol) new SimpleSymbol("add-to-global-var-environment").readResolve();
    static final SimpleSymbol Lit36 = (SimpleSymbol) new SimpleSymbol("is-bound-in-form-environment").readResolve();
    static final SimpleSymbol Lit35 = (SimpleSymbol) new SimpleSymbol("lookup-in-form-environment").readResolve();
    static final SimpleSymbol Lit34 = (SimpleSymbol) new SimpleSymbol("add-to-form-environment").readResolve();
    static final SimpleSymbol Lit33 = (SimpleSymbol) new SimpleSymbol("android-log-form").readResolve();
    static final SimpleSymbol Lit32 = (SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve();
    static final FString Lit31 = new FString("com.google.appinventor.components.runtime.Label");
    static final IntNum Lit30 = IntNum.make(new int[]{-1});
    static final IntNum Lit29 = IntNum.make(2);
    static final IntNum Lit28 = IntNum.make(22);
    ...
    static final IntNum Lit24 = IntNum.make(new int[]{-1});
    ...
    static final SimpleSymbol Lit21 = (SimpleSymbol) new SimpleSymbol("TextAlignment").readResolve();
    ...
    static final IntNum Lit8 = IntNum.make(new int[]{-13619152});
    ...
    public Screen1() {
        ...
        frameVar.$main = this;
        this.get$Mnsimple$Mnname = new ModuleMethod(frameVar, 1, Lit32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frameVar, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frameVar, 3, Lit33, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frameVar, 4, Lit34, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frameVar, 5, Lit35, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frameVar, 7, Lit36, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frameVar, 8, Lit37, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frameVar, 9, Lit38, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frameVar, 10, Lit39, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frameVar, 11, Lit40, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frameVar, 12, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frameVar, 13, Lit42, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frameVar, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frameVar, 15, Lit43, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frameVar, 16, Lit44, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frameVar, 17, Lit45, 8194);
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol4, "WhatsApp_Translate", simpleSymbol5);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit7, Lit8, Lit9);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit10, "ic_launcher.png", simpleSymbol5);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit11, "unspecified", simpleSymbol5);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit12, Boolean.TRUE, simpleSymbol3);
            runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit13, "Responsive", simpleSymbol5);
            Values.writeValues(runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit14, "Screen1", simpleSymbol5), $result);
        } else {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            ...
            addToComponents(simpleSymbol, Lit25, Lit16, lambda$Fn4);
        }
        this.Label2 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(simpleSymbol, Lit26, Lit27, lambda$Fn5), $result);
        } else {
            addToComponents(simpleSymbol, Lit31, Lit27, lambda$Fn6);
        }
        runtime.initRuntime();
    }
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit12, Boolean.TRUE, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit13, "Responsive", simpleSymbol5);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit14, "Screen1", simpleSymbol5);
    }

    static Object lambda4() {
        SimpleSymbol simpleSymbol = Lit16;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit17, Boolean.TRUE, Lit4);
        ...
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit20, "WhatsApp Translate+", Lit6);
    ...
    static Object lambda6() {
        ...
        SimpleSymbol simpleSymbol3 = Lit9;
        runtime.setAndCoerceProperty$Ex(simpleSymbol, simpleSymbol2, intNum, simpleSymbol3);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit20, "Seleccionar idioma que yo hablo", Lit6);
        runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit21, Lit29, simpleSymbol3);
        return runtime.setAndCoerceProperty$Ex(simpleSymbol, Lit23, Lit30, simpleSymbol3);
    }
