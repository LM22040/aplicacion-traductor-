...
public final class ChatBot extends AndroidNonvisibleComponent {
    ...
    public void performRequest(String uuid, String question, Bitmap image) {
        ...
        try {
            ...
            token = ChatBotToken.token.parseFrom(decodedToken);
        } catch (Exception e) {
            e = e;
        }
        try {
            ...
            ChatBotToken.request request = builder.m434build();
            ...
            Exception e3 = e;
            e3.printStackTrace();
            if (!(e3 instanceof FileNotFoundException) || connection == null) {
